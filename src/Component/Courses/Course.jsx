    ...
    return (
        <div className="card bg-white border border-gray-200 MAX-W-86  drop-shadow-lg rounded-lg overflow-hidden lg:max-w-96 ">
            ...
            <div className="p-5 text-blue-900">
                <h2 className="card-title text-xl font-semibold mb-2 text-blue-950 lg:text-2xl">{courseName}</h2>

                <div className="mb-3 flex items-center">
                    <FaClock className="text-black text-lg mr-2" />
                    <p className="text-base text-black lg:text-md"><span className='font-semibold'>Duration:</span> {courseDuration}</p>
                </div>

                <div className="mb-3 flex items-center">
                    <RiGraduationCapFill className="text-black text-lg mr-2" />
                    <p className="text-base text-black lg:text-md"><span className='font-semibold'>Minimum Qualification:</span> {minimumEducationalQualification}</p>
                </div>

                <div className="mb-3 flex items-center">
                    <FaUser className="text-black text-lg mr-2" />
                    <p className="text-base text-black lg:text-md"><span className='font-semibold'>Age Limit:</span> {ageLimit}</p>
                </div>
